...
process CONTAM_SMALL {
    ...
    script:
      """
      samtools view -@16 -q 20 -F 0x0704 -uh ${id}.bam 2 | samtools calmd -@16 -AEur - ${params.referenceFasta} |  samtools mpileup -@ 16 -s -O -f ${params.referenceFasta} -d 255 -l ${params.resourcesDir}/ExAC.r0.1.sites.vep.AF5.chr2.giab.liftover_b38.vcf - | bgzip -c > cleanCall_small.pileup.${id}.txt.gz
