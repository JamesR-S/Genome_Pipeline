...
process CONTAM_SMALL {
    ...
    script:
      """
      samtools view -q 20 -F 0x0704 -uh ${id}.bam 2 | samtools calmd -AEur - ${params.referenceFasta} |  samtools mpileup  -s -O -f ${params.referenceFasta} -d 255 -l ${params.resourcesDir}/ExAC.r0.1.sites.vep.AF5.chr2.giab.liftover_b38.vcf - | bgzip -c > cleanCall_small.pileup.${id}.txt.gz
